...
def character_selection_screen():
    ...
    while run_selection:
        ...
        draw_text('Select a Character', font, blue, screen_width // 2 - 200, screen_height // 2 - 200)
        male_button.draw()
        female_button.draw()
...
male_button = Button(screen_width // 2 - 100, screen_height // 2, character_images[Character.MALE][0])  # Use appropriate image for the male character
