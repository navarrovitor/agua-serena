...
#load sounds
pygame.mixer.music.load('./jogo/img/music.wav')
...
class Player():
	...
	def reset(self, x, y):
		...
		for num in range(1, 5):
			img_right = pygame.image.load(f'./jogo/img/guy{num}.png')
...
class World():
	def __init__(self, data):
		...
		#load images
		dirt_img = pygame.image.load('./jogo/img/dirt.png')
		grass_img = pygame.image.load('./jogo/img/grass.png')
...
class Lava(pygame.sprite.Sprite):
	def __init__(self, x, y):
		pygame.sprite.Sprite.__init__(self)
		img = pygame.image.load('./jogo/img/lava.png')
