...
background_image = pygame.image.load('images/instructions_image.png')
background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))
arrows_image_up = pygame.image.load('images/pixels_arrows-UP.png')
arrows_image_up = pygame.transform.scale(arrows_image_up, (300, 200))
arrows_image_LR = pygame.image.load('images/pixels_arrows-LR.png')
arrows_image_LR = pygame.transform.scale(arrows_image_LR, (300, 200))

image_directory_jump = "images/characterJump"
image_directory_walk = "images/characterWalk"
